      ...
      <section className="cta">
        <div className="container">
          <div className="cta-content">
            ...
            <p>Tải app OU FOOD ngay hôm nay và nhận ngay voucher 50k cho đơn hàng đầu tiên!</p>
            <div className="cta-buttons">
              <button className="btn-download">📱 Tải App iOS</button>
              <button className="btn-download">🤖 Tải App Android</button>
            </div>
          </div>
        </div>
      </section>
