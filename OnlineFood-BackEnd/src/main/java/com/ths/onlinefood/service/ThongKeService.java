...
//        logger.info("Thống kê doanh thu từ {} đến {}", tuNgay, denNgay);
...
//        logger.info("Thống kê doanh thu theo tháng năm {}", nam);
...
//        logger.info("Thống kê món ăn bán chạy từ {} đến {}, limit: {}", tuNgay, denNgay, limit);
...
//        logger.info("Thống kê voucher từ {} đến {}", tuNgay, denNgay);
        ...
        for (Object[] stat : voucherStats) {
            ...
            item.put("tongTienGiam", stat[5]);
            
            voucherData.add(item);
            tongTienGiam += ((Number) stat[5]).doubleValue();
            tongLuotSuDung += ((Number) stat[4]).intValue();
        }
        
        Map<String, Object> result = new HashMap<>();
        result.put("voucherData", voucherData);
        result.put("tongTienGiam", tongTienGiam);
...
//        logger.info("So sánh doanh thu giữa {} - {} và {} - {}", 
